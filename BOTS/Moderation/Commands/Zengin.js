...
if(![(config.OtherWorks.Booster)].some(role => message.member.roles.cache.get(role))) 
...
message.guild.members.cache.get(message.author.id).setNickname(`${config.Register.Tag} ${isim}`)
